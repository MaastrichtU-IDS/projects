const __b16bnode131 = new (require('@comunica/logger-void').LoggerVoid)({});
...
const __b0bnode320 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': '_:b0bnode320',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_rdf_serialize_Bus_RdfSerialize
});
const __b1bnode320 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
...
const __b0bnode314 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypes',
  'name': '_:b0bnode314',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
const __b1bnode314 = new (require('@comunica/mediator-combine-union').MediatorCombineUnion)({
  'field': 'mediaTypeFormats',
  'name': '_:b1bnode314',
  'bus': https___linkedsoftwaredependencies_org_bundles_npm__comunica_bus_sparql_serialize_Bus_SparqlSerialize
});
...
const https___linkedsoftwaredependencies_org_bundles_npm__comunica_actor_init_sparql__1_0_0_config_sets_sparql_serializers_json_myRdfSparqlSerializer = new (require('@comunica/actor-sparql-serialize-rdf').ActorSparqlSerializeRdf)({
  ...
  'mediatorMediaTypeCombiner': __b0bnode320,
  'mediatorMediaTypeFormatCombiner': __b1bnode320,
...
const urn_comunica_sparqlinit = new (require('./index.js').ActorInitSparql)({
  ...
  'mediatorSparqlSerializeMediaTypeCombiner': __b0bnode314,
  'mediatorSparqlSerializeMediaTypeFormatCombiner': __b1bnode314,
